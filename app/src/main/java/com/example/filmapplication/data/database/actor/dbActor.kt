...
fun dbActor.asDomainActor():Actor{
    return Actor(nconst=this.nconst, primaryName=this.primaryName,
...
fun List<dbActor>.asDomainActors():List<Actor>{
    return  this.map { Actor(nconst=it.nconst, primaryName=it.primaryName,
